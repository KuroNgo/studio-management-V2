  ...
  <main class=" py-20 h-screen">
    <div class="flex h-full w-3/4 mx-auto border border-solid border-gray-500">
      ...
      <div class="w-2/4 mt-auto mb-auto px-32">
        <h4 class="Heading4 uppercase text-center mb-3">Đăng nhập</h4>
        <p class="Subtitle2 text-center text-SecondColor mb-11">Chào mừng bạn !</p>
        <button class=" outline outline-1 rounded-xl p-3 w-full mb-5">
        ...
        <div class="flex justify-between gap-1 mb-7">
          <div class="flex gap-1">
            ...
            <p class="Overline text-gray-400">Nhớ mật khẩu</p>
          </div>
        ...
        <p class="Body2 text-center">Không có tài khoản ? <RouterLink to="/register"><strong class=" underline text-SecondColor">Đăng ký</strong> </RouterLink></p>
      </div>
    </div>
  </main>
</template>
